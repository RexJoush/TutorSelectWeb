              ...
              <el-row>
                <el-col :span="24">
                  <el-row :gutter="20">
                    ...
                    <el-col :span="8">
                      <el-form-item label="任硕导时间">
                        <el-date-picker
                          v-model="formSecond.firstDoctoralFirstTimeTutor"
                          format="yyyy-MM"
                    ...
                    <el-col :span="8">
                      <el-form-item label="任硕导一级学科">
                        <el-select
                          v-model="formSecond.firstDoctoralFirstDiscipline"
                          placeholder="请选择"
                          style="width: 100%"
                        >
                          <el-option
...
export default {
  ...
  data() {
    return {
      ...
      formSecond: {
        ...
        firstDoctoralFirstTimeTutor: '', // 任硕导时间
        firstDoctoralFirstDiscipline: '', // 任硕导一级学科
        major: '', // 主要研究方向的内容及其意义
  ...
  methods: {
    ...
    getFormSecond: function(data, tutorName) {
      ...
      this.formSecond.firstDoctoralFirstTimeTutor = data.firstDoctoralFirstTimeTutor
      this.formSecond.firstDoctoralFirstDiscipline = data.firstDoctoralFirstDiscipline
    ...
    onSubmitSecondPage: function() {
      this.$confirm('提交填写?')
        ...
        .then(() => {
          this.loading = true
          submitSecondPage(this.formSecond, 1, this.applyId, this.applyCondition).then(
            (res) => {
