    ...
    async getPaperList() {
      ...
      for (let i = 0; i < this.paperList.length; i++) {
        if (this.paperList[i].col1 === "不通过") {
          re11 += `论文${i + 1}名称：${this.paperList[i].paperName} ;` + `${i + 1}驳回原因:${this.paperList[i].col2}\n`;
        }
      }
    ...
    async getProjectList() {
      ...
      for (let i = 0; i < this.projectList.length; i++) {
        if (this.projectList[i].col1 === "不通过") {
          re22 += `项目${i + 1}名称：${this.projectList[i].projectName} ;` + `${i + 1}驳回原因:${this.projectList[i].col2} \n`;
        }
      }
    ...
    async getWorkList() {
      ...
      for (let i = 0; i < this.workList.length; i++) {
        if (this.workList[i].col1 === "不通过") {
          re33 += `项目${i + 1}名称：${this.workList[i].worksName} ;` + `${i + 1}驳回原因:${this.workList[i].col2} \n`;
        }
      }
    ...
    async getAwardList() {
      ...
      for (let i = 0; i < this.awardList.length; i++) {
        if (this.awardList[i].col1 === "不通过") {
          re44 += `项目${i + 1}名称:${this.awardList[i].awardsName} ;` + `${i + 1}驳回原因:${this.awardList[i].col2} \n`;
        }
      }
